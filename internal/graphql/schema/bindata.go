...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 1891, mode: os.FileMode(420), modTime: time.Unix(1647344214, 0)}
...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 1004, mode: os.FileMode(420), modTime: time.Unix(1647277130, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func typeUserGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "type/user.graphql", size: 1049, mode: os.FileMode(420), modTime: time.Unix(1647344214, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
