...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 1228, mode: os.FileMode(420), modTime: time.Unix(1645108896, 0)}
...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 656, mode: os.FileMode(420), modTime: time.Unix(1645112656, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
