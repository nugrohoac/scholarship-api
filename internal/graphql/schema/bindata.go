...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 2263, mode: os.FileMode(420), modTime: time.Unix(1650273065, 0)}
