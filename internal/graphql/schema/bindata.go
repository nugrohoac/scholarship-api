...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 1359, mode: os.FileMode(420), modTime: time.Unix(1645710983, 0)}
...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 854, mode: os.FileMode(420), modTime: time.Unix(1645633111, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
