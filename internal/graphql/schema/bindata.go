...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 2063, mode: os.FileMode(420), modTime: time.Unix(1649470908, 0)}
...
func typeApplicantGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "type/applicant.graphql", size: 311, mode: os.FileMode(420), modTime: time.Unix(1649483379, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func typeAssessmentGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "type/assessment.graphql", size: 144, mode: os.FileMode(420), modTime: time.Unix(1649470908, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
