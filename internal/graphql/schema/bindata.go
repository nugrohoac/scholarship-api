...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 2200, mode: os.FileMode(420), modTime: time.Unix(1650268726, 0)}
...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 1784, mode: os.FileMode(420), modTime: time.Unix(1650268735, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
