...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 530, mode: os.FileMode(420), modTime: time.Unix(1642817129, 0)}
...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 358, mode: os.FileMode(420), modTime: time.Unix(1642817167, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
