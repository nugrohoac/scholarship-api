...
func mutationGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "mutation.graphql", size: 1068, mode: os.FileMode(420), modTime: time.Unix(1644665099, 0)}
...
func typeScholarshipGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "type/scholarship.graphql", size: 517, mode: os.FileMode(420), modTime: time.Unix(1644664398, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
