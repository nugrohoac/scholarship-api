...
func queryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphql", size: 751, mode: os.FileMode(420), modTime: time.Unix(1645266211, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func typeMajorGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "type/major.graphql", size: 102, mode: os.FileMode(420), modTime: time.Unix(1645266207, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
